        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              Discover our handcrafted diamond pieces, each one unique and stunning. Our master craftsmen select only
              the finest diamonds to create jewelry that will be treasured for generations.
            </p>
