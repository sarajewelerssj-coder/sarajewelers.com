...
export default function CustomDesignBanner() {
  return (
    <section className="py-20 relative overflow-hidden bg-white dark:bg-[#1e1e1e]">
      ...
      <div className="container mx-auto px-4 relative max-w-7xl">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center lg:grid-flow-col-dense">
          <div className="lg:order-2 lg:col-start-2 flex flex-col justify-center">
          ...
          <div className="lg:order-1 lg:col-start-1 relative">
            <div className="relative aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl hover:shadow-[#d4af37]/30 dark:hover:shadow-[#f4d03f]/30 transition-all duration-500 hover:scale-105">
              <Image
                ...
                alt="Custom Design Your Dream Jewelry"
                fill
